...
CrowdNode.main = {
  ...
  knowledge: "https://knowledge.crowdnode.io",
  hotwallet: "",
};
...
CrowdNode._knowledgeBaseUrl = CrowdNode.main.knowledge;
...
CrowdNode.init = async function ({ baseUrl, insightBaseUrl, knowledgeBaseUrl }) {
  ...
  CrowdNode._knowledgeBaseUrl = knowledgeBaseUrl || CrowdNode.main.knowledge;
